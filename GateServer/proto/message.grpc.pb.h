   ...
   public:
    WithStreamedUnaryMethod_GetVerifyCode() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::message::GetVerifyReq, ::message::GetVerifyRsp>(std::bind(&WithStreamedUnaryMethod_GetVerifyCode<BaseClass>::StreamedGetVerifyCode, this, std::placeholders::_1, std::placeholders::_2)));
    }
